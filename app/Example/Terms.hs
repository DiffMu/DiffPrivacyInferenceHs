...
simplelam = Lam [(UserTeVar $ Symbol "x") :- (JTNumInt), (UserTeVar $ Symbol "y") :- (JTAny)] (t3 "y")
...
t6 = Lam [(UserTeVar $ Symbol "y") :- (JTAny)] (SLet ((UserTeVar $ Symbol "x") :- (JTAny)) (Sng 3 JTNumInt) (Op (IsBinary DMOpMul) [(var "x"), (var "y")]))

t7 = Lam [(UserTeVar $ Symbol "x") :- (JTNumInt), (UserTeVar $ Symbol "y") :- (JTAny)] (t5 t4 t2)
...
-- t21 = Lam [(UserTeVar $ Symbol "x") :- (JTNumInt)] (TLet [arg "x", arg "y", arg "z"] t20 (Op (IsBinary DMOpAdd) [t3 "y", t5 (t3 "y") (t3 "z")]))
